      ...
      <div className={`${css.top} ${currentUser ? '!tw-bg-[#223E70]' : ''}`}>
        <div className={css.top__inner + " tw-container tw-px-4"}>
          ...
          <div className="tw-flex tw-gap-3 ">
            <ButtonMain icon="/images/navbar/icons/usicon.png" color="grey" variant="outline" classNames="border-1 p-3 text-center tw-w-[50px] max-desktop:tw-hidden" text={""} />
            <ButtonMain onClick={() => setProfile((e) => !e)} icon="/images/navbar/icons/profileicon.png" color="grey" variant="outline" classNames={`border-1 p-3 text-center tw-w-[50px] tw-ml-4 ${css.profile}`} text={""} />
            {profile ? (
        isMobile ? (
