        ...
        <div className={css.top__inner + " tw-container tw-px-4"}>
          ...
          {currentUser ?
            <div className="tw-flex tw-gap-3 ">
              {/* <ButtonMain icon="/images/navbar/icons/usicon.png" color="grey" variant="outlined" classNames="border-1 p-3 text-center tw-w-[50px] max-desktop:tw-hidden" /> */}
              <ButtonMain onClick={() => setProfile((e) => !e)} icon="/images/navbar/icons/profileicon.png" color="grey" variant="outlined" classNames={`border-1 p-3 text-center tw-w-[50px] tw-ml-4 ${css.profile}`} />
              {profile ? (
                isMobile ? (
