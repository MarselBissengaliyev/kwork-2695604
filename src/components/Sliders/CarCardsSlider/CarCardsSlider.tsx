          ...
          <SwiperSlide key={img.src}>
            <div>
              ...
              {deletes ? (
                <button
                  onClick={() => handleClick()}
                  className="tw-absolute tw-top-0 tw-right-0 tw-p-[10px] tw-bg-[#FFFFFF] tw-h-[34px] tw-w-[34px] tw-m-[20px] tw-text-center tw-items-center tw-flex tw-justify-center tw-rounded-full"
                >
                  <img className=" tw-w-[16px] tw-h-[16px]" src="/images/dashboard/icons/trash.png" />
                </button>
              ) : null}
              {click ? (
                <div
                  className="tw-absolute tw-top-[60px] tw-right-[20px] tw-max-w-[270px] tw-w-full tw-p-[30px] tw-bg-[#FFFFFF] tw-rounded-[10px] tw-text-center tw-flex tw-justify-center tw-flex-col tw-gap-[10px]"
                  style={{ zIndex: "9999" }}
                >
