...
const InfoUpdateForm = ({ currentUser }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      facebook: currentUser && currentUser.facebook ? currentUser.facebook : '',
      linkedin: currentUser && currentUser.linkedin ? currentUser.linkedin : '',
      youtube: currentUser && currentUser.youtube ? currentUser.youtube : '',
    },
  })
        ...
        <div className="authentication-content">
          ...
          <form className="authentication" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="form-group mb-0">
              <Button label="Update My Info" disabled={isLoading} />
            </div>
          </form>
        </div>
      </div>
