        ...
        >
          <SwiperSlide>
            <div className="partner-item">
              <Image src={partner1} width={215} height={100} alt="partner" />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="partner-item">
              <Image src={partner2} width={215} height={100} alt="partner" />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="partner-item">
              <Image src={partner3} width={215} height={100} alt="partner" />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="partner-item">
              <Image src={partner4} width={215} height={100} alt="partner" />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="partner-item">
              <Image src={partner5} width={215} height={100} alt="partner" />
            </div>
          </SwiperSlide>
          <SwiperSlide>
            <div className="partner-item">
              <Image src={partner6} width={215} height={100} alt="partner" />
            </div>
          </SwiperSlide>
        </Swiper>
      </div>
